...
interface RiderAssignedScreenProps {
    onBack?: () => void;
    onPickUp?: () => void;
}

export default function RiderAssignedScreen({ onBack, onPickUp }: RiderAssignedScreenProps) {
    return (
        <div className="w-full max-w-xl mx-auto py-4 md:py-8 font-sans">
            ...
            <p className="text-[15px] font-medium text-[#666666] mb-10">
                Be on your way to pick up the rider.
            </p>
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="relative h-20 flex items-center mb-8 px-4">
                        <div className="w-full h-[3px] bg-gray-100 rounded-full relative">
                            ...
                            {/* Car marker */}
                            <div className="absolute left-[15%] -translate-y-[15px]">
                                <Image
                                ...
                                <div className="p-1 bg-white rounded shadow-sm border border-gray-100" style={{ display: 'none' }}>🚗</div>
                            </div>
                            {/* Destination marker */}
            ...
            {onBack && (
                <button
                    onClick={onBack}
                    className="mt-6 text-[13px] text-[#0B153D] font-bold bg-[#F5F5F7] px-4 py-2 rounded-full hover:bg-gray-200"
                >
                    Reset Flow view
                </button>
            )}
