        ...
        <div className="flex-1 flex flex-col max-w-[600px]">
          <div className="bg-[#F5F5F7] rounded-[16px] p-6 flex flex-col gap-8">
            ...
            <div className="flex flex-col">
              <h3 className="text-[24px] font-semibold text-[#0B153D] leading-[140%] mb-4">
                Login Alerts
              </h3>
              <div className="bg-white rounded-[8px] flex flex-col overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                <div className="flex items-center justify-between px-5 py-4">
                  ...
                  <CustomToggle
                    checked={loginEmail}
                    onChange={() => setLoginEmail(!loginEmail)}
                  />
                </div>
            ...
            {/* Update Alerts Group */}
            <div className="flex flex-col">
              <h3 className="text-[24px] font-semibold text-[#0B153D] mb-4">
                Update Alerts
              </h3>
              <div className="bg-white rounded-[8px] flex flex-col overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                <div className="flex items-center justify-between px-5 py-4">
                ...
                <div className="flex items-center justify-between px-5 py-4">
                  ...
                  <CustomToggle
                    checked={updatePush}
                    onChange={() => setUpdatePush(!updatePush)}
                  />
                </div>
              </div>
            </div>
