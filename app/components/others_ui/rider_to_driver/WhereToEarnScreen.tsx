...
export default function WhereToEarnScreen() {
    ...
    return (
        <div className="w-full max-w-5xl mx-auto bg-white font-sans">
            {/* Content Box */}
            <div className="flex flex-col items-center justify-center p-8 py-20 md:pt-16 md:pb-32 max-w-lg mx-auto w-full text-center">
                ...
                <button
                    ...
                    className="bg-[#0B153D] hover:bg-[#070e28] text-white font-semibold py-4 px-12 rounded-[12px] w-full text-[15px] transition-colors shadow-md"
                >
                    Continue
                </button>
            </div>
