...
export default function AboutCards() {
  ...
  const images = [
    "/icons/box.webp",      // or whatever your car icon path is
    "/icons/box-1.webp", // or whatever your motorcycle icon path is
    "/icons/box-2.webp"   // or whatever your verified icon path is
  ];
