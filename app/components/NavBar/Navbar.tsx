...
// import * as Icons from "lucide-react"; // ✅ icons source
...
//       "
//     >
//       <Icon size={22} className="text-[#00000066]" />
...
//                 >
//                   <span className="text-[18px] font-medium text-text-black hover:text-[#A20602] transition-colors">
//                     {l.title}
//                   </span>
