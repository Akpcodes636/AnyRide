...
export default function ProfilePopover({ isOpen, onClose }: ProfilePopoverProps) {
    ...
    return (
        <div className="absolute right-0  w-[411px] bg-white shadow-[0_20px_50px_rgba(0,0,0,0.15)] rounded-[24px] overflow-hidden z-[100]  transform origin-top-right animate-in fade-in slide-in-from-top-2 duration-200 max-h-[80vh] overflow-y-auto scrollbar-hide">
            ...
            <div className="py-2 px-2 flex flex-col gap-1 pb-4">
                <Link href="/account" onClick={onClose} className="flex items-center gap-4 px-6 py-3.5  hover:bg-[#F5F5F7] rounded-[16px] transition-colors group/item">
                    <AiOutlineUser  className="w-5 h-5 text-[#A0A0A0] group-hover/item:text-[#0B153D]" />
                    <span className="text-[18px] font-bold text-[#333333]">Manage account</span>
                </Link>
                ...
                <Link href="/my-rides" onClick={onClose} className="flex items-center gap-4 px-6 py-3.5 hover:bg-[#F5F5F7] rounded-[16px] transition-colors group/item">
                    ...
                    <span className="text-[18px] font-bold text-[#333333]">My Rides</span>
                </Link>
                ...
                <Link href="/safety" onClick={onClose} className="flex items-center gap-4 px-6 py-3.5 hover:bg-[#F5F5F7] rounded-[16px] transition-colors group/item">
                    <Shield className="w-5 h-5 text-[#A0A0A0] group-hover/item:text-[#0B153D]" />
                    <span className="text-[18px] font-bold text-[#333333]">Safety</span>
                </Link>
                <Link href="/about" onClick={onClose} className="flex items-center gap-4 px-6 py-3.5 hover:bg-[#F5F5F7] rounded-[16px] transition-colors group/item">
                    ...
                    <span className="text-[18px] font-bold text-[#333333]">About</span>
                </Link>
            </div>
