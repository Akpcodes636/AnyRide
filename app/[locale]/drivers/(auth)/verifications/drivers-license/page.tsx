...
export default function DriversLicensePage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans px-4 pt-[60px] pb-20 container mx-auto">
      <h2 className="mb-8">Driving license</h2>
            ...
            {files.length > 0  && (
              <div className="flex flex-col gap-2 px-4 pt-2 pb-3 bg-white">
                {files.map((file, i) => (
                 ...
                 <Folder className="text-[#59CAFC]" size={28} fill="#0074A8" />
                    </div>
      ...
      {stage !== "success" && (
        <p className="mt-6 text-[10px] text-gray-400 leading-[140%] bg-[#F6E6E6] p-2 rounded-[8px] max-w-[616px] w-full mx-auto">
          <span className="font-semibold text-[#A20602]">Note:</span> Driver
          was punctual, polite, and the car was very clean. Smooth and safe
          driving the whole way. Really appreciated the professionalism and
          friendly conversation. Would definitely ride again.
        </p>
      )}
    </div>
  );
